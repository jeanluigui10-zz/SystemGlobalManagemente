<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="RegistroCategoria.aspx.cs" Inherits="System_Maintenance.Private.Registro.RegistroCategoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <script type="text/javascript">
        ...
        function Fn_RecargarLista() {
            ...
            fn_callmethod("RegistroCategoria.aspx/Recargar_Lista", "", success, error);
        }      

        function Fn_Registro()
        {
         
            if ($("input[id$=txtNombreCategoria]").val().replace(/^\s+|\s+$/g, "").length == 0) {
            ...
            obj = {
                Nombre_Categoria : $("input[id$=txtNombreCategoria]").val().trim(),   
                Descripcion_Categoria : $("input[id$=txtDescripcion]").val().trim(),  
                Estado : isChecked
            }
            var success = function (asw) {
                if (asw != null) {
            ...
            fn_callmethod("RegistroCategoria.aspx/Registro", JSON.stringify(data), success, error);
        }

        function Fn_Limpiar() {
            $("input[id$=txtNombreCategoria]").val("");
    ...
    <div class="box box-warning">
        ...
        <div class="box-header with-border">
            <h3 <%--class="box-title"--%> style="text-align: center">Registro de Categorias</h3>
        </div>
        <div class="box-body">
          <%--  <div class="form-group">
                <label>Nombre Ambiente</label>
                <asp:TextBox ID="txtNombreCategoria" runat="server" type="text" CssClass="form-control"></asp:TextBox>
            </div>--%>
            <div class="form-group">
