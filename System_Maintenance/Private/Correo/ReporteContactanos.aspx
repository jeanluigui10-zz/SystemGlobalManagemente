<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ReporteContactanos.aspx.cs" Inherits="System_Maintenance.Private.Correo.ReporteContactanos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <script type="text/javascript">
        ...
        function Fn_RecargarLista() {
            ...
            var success = function (asw) {
                if (asw != null) {
                    if (asw.d.Result == "Ok") {
                        ...
                        Fn_LlenarTable(asw.d.lstContactanos);
            ...
            fn_callmethod("ReporteContactanos.aspx/Cargar_Contactanos", JSON.stringify({fechaInicio : inicio, fechaFin:fin}), success, error);
        }
    </script>
    ...
    <div class="box">
        ...
        <div class="box-header">
            <h3 class="box-title">Lista Contactanos</h3>
