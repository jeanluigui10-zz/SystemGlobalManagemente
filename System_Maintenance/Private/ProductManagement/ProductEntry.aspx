 ...
 <script type="text/javascript">
     ...
     function Fn_fillTable2(data) {
        ...
        function Fn_RowEdit(Id) {
            window.location.href = "ProductEntrySave.aspx?q=" + Id;
        }

    	   function Fn_new() {
                    window.location.href = "ProductEntrySave.aspx"; 
        }
            ...
            if (len > 0) {
                bootbox.confirm("¿Está seguro de que desea eliminar este registro(s)?", function (result) {
                    if (result) {
                        ...
                        fn_callmethod("ProductEntry.aspx/SendDelete", senddata, success, error);
                    }
                });
            }
                    ...
                    <div class="form-horizontal form-bordered " id="fCompany">
                        ...
                        <div class="row">
                            <div class="col-md-9 cnt-controles">
                                ...
                                <a class="mb-xs mt-xs mr-xs btn btn-danger" onclick="Fn_delete()" id="A2"><i class="fa fa-times"></i><span>&nbsp;Eliminar</span> </a>
                            </div>
                        </div>
