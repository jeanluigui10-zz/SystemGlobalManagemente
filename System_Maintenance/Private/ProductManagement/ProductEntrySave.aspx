...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_validate2(event) {
            ...
            if (/[<>]+/.test($("#<%=txtUnitPrice.ClientID %>").val())) {
                fn_message('i', "Invalid Name input. The tags '>' and '<' are not allowed.");
                event.preventDefault();
                return false;

            }
            if (/[<>]+/.test($("#<%=txtStock.ClientID %>").val())) {
                fn_message('i', "Invalid Name input. The tags '>' and '<' are not allowed.");
                event.preventDefault();
                return false;
            }
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div id="editBasic" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblSKU" runat="server" Text="" CssClass="col-sm-4 col-md-3 col-lg-2  cnt-text-label"></asp:Label>
                            <div class="col-xs-12 col-sm-7 col-md-6 col-lg-7 cnt-controles">
                                <asp:TextBox ID="txtSku" disabled runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
                            </div>
                        </div>
